...
namespace Sparrow.Qweather.Models.Response.Geo
{
    ...
    /// POI范围搜索
    /// </summary>
    public class PoiRangeReponse : CommonInfoResponse
    {
        /// <summary>
        /// POI
        /// </summary>
        [JsonPropertyName("poi")]
        public List<PoiRangePoiItem> Poi { get; set; }
    }

    /// <summary>
    /// 表示单个 POI（兴趣点）的信息
    /// </summary>
    public class PoiRangePoiItem
    {
        /// <summary>
        /// POI 名称
        /// </summary>
        /// <example>中山公园</example>
