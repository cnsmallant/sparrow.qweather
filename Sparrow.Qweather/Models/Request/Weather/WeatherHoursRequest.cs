...
namespace Sparrow.Qweather.Models.Request.Weather
{
    ...
    /// 逐小时天气预报
    /// </summary>
    public class WeatherHoursRequest
    {
        /// <summary>
        ///路径参数
        /// </summary>
        public WeatherHoursPathParameters Path { get; set; }

        /// <summary>
        /// 查询参数
        /// </summary>
        public WeatherHoursQueryParameters Query { get; set; }
    }

    /// <summary>
    /// 路径参数
    /// </summary>
    public class WeatherHoursPathParameters
    {
        /// <summary>
        /// hours(必选)预报小时数，支持最多168小时预报，可选值：24h 24小时预报。72h 72小时预报。168h 168小时预报。
        /// </summary>
    ...
    /// 查询参数
    /// </summary>
    public class WeatherHoursQueryParameters : CommonInfoRequest
    {
        /// <summary>
